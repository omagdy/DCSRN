...
def train_step(real_x, real_y, generator_g, generator_optimizer, LOSS_FUNC):
    ...
    with tf.GradientTape(persistent=True) as tape:
        ...
        gen_g_super_loss = supervised_loss(real_y, fake_y, LOSS_FUNC)
...
#             batch_label = get_batch_data(data_y, i, BATCH_SIZE)
            generator_loss = train_step(batch_data, batch_label, generator_g, generator_optimizer, LOSS_FUNC).numpy()
